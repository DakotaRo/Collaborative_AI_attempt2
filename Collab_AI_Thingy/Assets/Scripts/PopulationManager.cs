...
public class PopulationManager : MonoBehaviour {
	...
	{
		List<GameObject> sortedList = population.OrderByDescending(o => o.GetComponent<Brain>().offenseBlocked).ToList();
		string offenseBlocked = "Generation: " + generation;
		foreach(GameObject g in sortedList)
		{
			offenseBlocked += ", " + g.GetComponent<Brain>().offenseBlocked;
		}
		Debug.Log("Offense: " + offenseBlocked);
		population.Clear();
